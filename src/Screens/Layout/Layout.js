...
export const Layout = ({ contentComponent }) => {
  return (
    <main>
      ...
      <footer>
        <h4>Napište na <a  href="mailto:veronika.pucerova@gmail.com">veronika.kovarova@pirati.cz</a> pokud máte připomínky, nápady nebo jste našli nefunkční odkaz, děkuji. _ _ _ _ _  Stránky naprogramoval <a  href="https://www.michalmucha.info"> Michal Mucha</a>. </h4>
      </footer>
