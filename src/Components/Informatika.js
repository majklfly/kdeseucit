...
export const Informatika = () => {
  return (
    <div className="BoxProKarty">
      <a
        href="https://pripravy.estranky.cz/clanky/informatika.html"
        target="_blank"
        rel="noreferrer"
      >
      ...
      >
        <img
          ...
          alt="Umíme programovat"
        />
      </a>
      <a
        href="https://cs.khanacademy.org/computing"
        target="_blank"
        rel="noreferrer"
      >
      ...
      >
        <img
          ...
          title="Zdroje sdružení domů dětí a mládeže"
        />
      </a>
      <a
      ...
      >
        <img
          className="obrazekKarty"
          src={chmelinf}
          alt="Chmelková informatika pro 4.třídu"
        />
      </a>
      <a
        href="http://www.nabla.cz/obsah/programovani/"
        target="_blank"
        rel="noreferrer"
      >
      ...
      >
        <img
          className="obrazekKarty"
          src={ajtak}
          alt="Naprogramuj si vlastní hru"
      ...
      >
        <img
          className="obrazekKarty"
          src={ai}
          alt="Umělá inteligence - co to je?"
          title="Umělá inteligence - co to je?"
        />
      </a>
      <a href="https://cs.wix.com/" target="_blank" rel="noreferrer">
        <img
          className="obrazekKarty"
          src={wix}
          alt="Vytvoř si webové stránky"
          title="Vytvoř si webové stránky"
        />
      </a>
