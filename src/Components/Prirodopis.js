...
export const Prirodopis = () => {
  return (
    <div className="BoxProKarty">
      <a
        href="https://www.skolasnadhledem.cz/profil/2-stupen/881-prirodopis"
        target="_blank"
        rel="noreferrer"
      >
        <img
      ...
      <a
        href="http://www.nabla.cz/obsah/biologie/"
        target="_blank"
        rel="noreferrer"
      >
      ...
      <a
        href="https://edu.ceskatelevize.cz/predmet/prirodopis"
        target="_blank"
        rel="noreferrer"
      >
      ...
      <a
        href="https://www.ucenionline.com/priroda/"
        target="_blank"
        rel="noreferrer"
      >
      ...
      >
        <img
          className="obrazekKarty"
          src={svycarsko}
          alt="Národní park České Švýcarsko"
        />
      </a>
      <a
