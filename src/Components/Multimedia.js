...
export const Multimedia = () => {
    return (
        <div className="BoxProKarty">
            ...
            <a href="https://sumo.app/paint/en" target="_blank" rel="noreferrer">
            ...
            <a href="https://www.escapemotions.com/community/experiments/fluid_painter/index.php" target="_blank" rel="noreferrer">
                <img className="obrazekKarty" src={fluid} alt="fluid" />
            </a>
            <a href="https://www.theoworlds.com/halloween/" target="_blank" rel="noreferrer">
            ...
            <a href="https://www.czechitas.cz/cs/blog/zaciname-s-it/naprogramuj-si-vlastni-hru" target="_blank" rel="noreferrer">
                <img className="obrazekKarty" src={ajtak} alt="ajtak" />
            </a>
            ...
            <a href="https://scratch.mit.edu/" target="_blank" rel="noreferrer">
                <img className="obrazekKarty" src={scratch} alt="scratch" />
            </a>
            <a href="https://cs.wix.com/" target="_blank" rel="noreferrer">
                <img className="obrazekKarty" src={wix} alt="wix" />
            </a>
        </div>
    )
}