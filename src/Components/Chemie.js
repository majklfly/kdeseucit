...
export const Chemie = () => {
    return (
        <div className="BoxProKarty">
            <a href="https://www.skolasnadhledem.cz/profil/2-stupen/820-chemie" target="_blank" rel="noreferrer">
                <img className="obrazekKarty" src={snadhledem} alt="snadhledem" />
            </a>
            <a href="https://www.umimefakta.cz/chemie" target="_blank" rel="noreferrer">
                <img className="obrazekKarty" src={umimefakta} alt="Umíme fakta" />
            </a>
            <a href="https://www.youtube.com/user/anubiskt/videos" target="_blank" rel="noreferrer">
            ...
            <a href="http://www.nabla.cz/obsah/chemie/" target="_blank" rel="noreferrer">
            ...
            <a href="http://www.testpark.cz/testy/chemie" target="_blank" rel="noreferrer">
                <img className="obrazekKarty" src={testpark} alt="Test park" />
            </a>
            <a href="https://edu.ceskatelevize.cz/predmet/chemie" target="_blank" rel="noreferrer">
                <img className="obrazekKarty" src={ctedu} alt="ČT edu" />
            </a>
            <a href="https://www.maths.cz/clanek/kategorie/29" target="_blank" rel="noreferrer">
                <img className="obrazekKarty" src={maprokazdeho} alt="Matematika pro každého" />
            </a>
            <a href="https://phet.colorado.edu/cs/simulations/filter?subjects=chemistry&type=html&sort=alpha&view=grid" target="_blank" rel="noreferrer">
                <img className="obrazekKarty" src={animacechemie} alt="Animace chemických jevů" />
            </a>
            <a href="http://www.vedaneniveda.cz/vyukove-materialy-pro/2-stupen-zakladnich-skol/chemie" target="_blank" rel="noreferrer">
