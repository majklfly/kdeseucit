...
export const ZSV = () => {
    return (
        <div className="BoxProKarty">
            ...
            <a href="https://www.jsns.cz/distancni-vyuka" target="_blank" rel="noreferrer">
                <img className="obrazekKarty" src={jedensvet} alt="jedensvet" />
            </a>
            <a href="http://www.respektneboli.eu/pedagogove/materialy-k-vyuce" target="_blank" rel="noreferrer">
            ...
            <a href="https://edu.ceskatelevize.cz/predmet/psychologie-a-sociologie" target="_blank" rel="noreferrer">
                <img className="obrazekKarty" src={ctedu} alt="ctedu" />
            </a>
            <a href="http://medialnigramotnost.fsv.cuni.cz/zobraz/tema/medialni-obsahy?pos=13,18" target="_blank" rel="noreferrer">
                <img className="obrazekKarty" src={medialnigramotnost} alt="medialnigramotnost" />
            </a>
