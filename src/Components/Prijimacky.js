...
export const Prijimacky = () => {
    return (
        <div className="BoxProKarty">
            ...
            <a href="https://skolaposkole.cz/prijimaci-zkousky-stredni-skoly" target="_blank" rel="noreferrer">
                <img className="obrazekKarty" src={skolaposkole9} alt="skolaposkole9" />
            </a>
            <a href="https://umimcestinu.wordpress.com/" target="_blank" rel="noreferrer">
            ...
            <a href="https://www.youtube.com/channel/UCOCsqf9KoHNAuCj_5iVR6sA/" target="_blank" rel="noreferrer">
